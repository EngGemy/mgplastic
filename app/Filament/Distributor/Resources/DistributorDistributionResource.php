...
use App\Filament\Distributor\Resources\DistributorDistributionResource\Pages;
...
class DistributorDistributionResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListDistributorDistributions::route('/'),
            'create' => Pages\CreateDistributorDistribution::route('/create'),
            'view' => Pages\ViewDistributorDistribution::route('/{record}'),
        ];
    }
}
